...
class Usermanager(UserManager):
    def _create_user(self, username, fullname,  email, password, phone_number, **extra_fields):
        if not email:
    ...
    def create_user(self, username, email=None, fullname=None, password=None, phone_number=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
        return self._create_user(email, username, password, fullname, phone_number **extra_fields)
